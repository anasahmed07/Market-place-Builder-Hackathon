...
export function ProductCard(prams: TypeProduct) {
    ...
    return (
        <div className={`${satoshi.className} whitespace-normal box-border min-w-48 w-72 space-y-5 rounded-2xl p-2 cursor-pointer hover:shadow-md transition duration-300 ease-in-out`}>
